...
const ShrinkIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M4 14h4v4m0-4l-5 5m16-5h-4v4m0-4l5 5M4 10h4V6m0 4l-5-5m16 5h-4V6m0 4l5-5"
    />
  </svg>
);
const FilterIcon = () => (
...
export default function LivePlayer({ userId, guildId }) {
  ...
  if (isFullscreen) {
    return (
      <div
        className={`fixed inset-0 z-[200] bg-black text-white flex flex-col justify-between overflow-hidden animate-fadeIn transition-colors duration-1000 ${isIdle ? "cursor-none" : ""}`}
      >
        <style
  ...
  return (
    <>
            ...
            {localQueue.length > 0 ? (
              localQueue.map((s, i) => (
                ...
                >
                  ...
                  <img
                    src={s.thumbnail}
                    className="w-8 h-8 md:w-10 md:h-10 rounded object-cover flex-shrink-0 border border-white/5"
                    alt=""
                  />

                  <div className="flex flex-col min-w-0 flex-1 pr-6">
                    <span className="text-xs md:text-sm font-bold text-gray-200 truncate">
                      {s.title}
                    </span>
                    <span className="text-[9px] md:text-[10px] text-gray-500 font-bold uppercase truncate">
                      {String(s.artist)}
                    </span>
                  </div>
      ...
      <div
        ...
        style={{
          background: `linear-gradient(90deg, ${activeColor}20 0%, rgba(10,10,12,0.95) 30%, rgba(10,10,12,0.95) 100%)`,
        ...
        <div className="flex items-center justify-start w-[70%] md:w-1/4 gap-3 md:gap-4 overflow-hidden">
          ...
          >
            <img
              src={status.song.thumbnail}
              alt="Cover"
              className="w-14 h-14 rounded-md shadow-md object-cover hover:opacity-50 transition border border-white/10"
            />
          ...
          <img
            src={status.song.thumbnail}
            alt="Cover"
            className="w-10 h-10 rounded shadow-md object-cover md:hidden shrink-0 border border-white/10"
          />
              ...
              <div className="relative">
                ...
                {showFilterMenu && (
                  <div className="absolute bottom-12 left-1/2 -translate-x-1/2 w-40 bg-[#0a0a0c]/90 backdrop-blur-xl border border-[#7e22ce]/30 rounded-xl shadow-2xl p-2 z-[60] animate-fadeIn">
                    <p className="text-[9px] font-black uppercase text-[#7e22ce] mb-2 px-2 pt-1 text-center border-b border-white/10 pb-2 tracking-widest">
                    ...
                    <div className="flex flex-col gap-1">
                      <button
                        ...
                        className="text-xs font-bold text-gray-300 hover:text-white hover:bg-white/10 p-2 rounded transition"
                      >
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          setFilter(
                            "asetrate=44100*1.25,aresample=44100,atempo=1",
                          );
                        }}
                        className="text-xs font-bold text-gray-300 hover:text-white hover:bg-white/10 p-2 rounded transition"
                      >
                    ...
                    <div className="max-h-48 overflow-y-auto custom-scrollbar flex flex-col gap-1">
                      {playlists.map((pl) => (
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            saveToPlaylist(pl.id);
                          }}
                          className="w-full text-left text-[11px] p-2 hover:bg-white/10 rounded-md transition truncate font-bold text-gray-300"
                        >
                          {pl.name}
                        </button>
                      ))}
