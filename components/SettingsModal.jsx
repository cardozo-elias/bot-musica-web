      ...
      <div className="w-full max-w-2xl glass-panel bg-[#111214]/95 rounded-3xl shadow-2xl border border-white/10 flex flex-col overflow-hidden animate-slideUp">
        <div className="p-6 border-b border-white/5 flex justify-between items-center bg-black/20">
          ...
          <button
            ...
            className="text-gray-500 hover:text-white transition text-3xl leading-none"
          >
            &times;
          </button>
        </div>
                ...
                <div className="glass-panel p-5 rounded-2xl border border-white/5 flex items-center justify-between">
                  <div className="flex flex-col pr-4">
                    ...
                    <span className="text-xs text-gray-500 mt-1">
                      No registrar lo que escucho en mi perfil público ni en mis
                      estadísticas.
                    </span>
                  </div>
                  <button
              ...
              <div className="flex flex-col gap-6 animate-fadeIn">
                <div>
                  ...
                  >
                    ...
                    <option value="bass=g=15">
                      Bassboost (Graves Profundos)
                    </option>
                    <option value="apulsator=hz=0.09">
                      8D Audio (Inmersivo)
                    </option>
                    <option value="asetrate=44100*1.25,aresample=44100,atempo=1">
                      Nightcore
                    </option>
                  </select>
                </div>
                <div className="glass-panel p-5 rounded-2xl border border-white/5 flex items-center justify-between mt-2">
                  <div className="flex flex-col pr-4">
                    ...
                    <span className="text-xs text-gray-500 mt-1">
                      Ideal para conexiones lentas o ahorrar RAM.
                    </span>
                  </div>
                  <button
                    onClick={() =>
        ...
        <div className="p-4 border-t border-white/5 bg-black/40 flex justify-end gap-3">
          <button
            onClick={() => setIsOpen(false)}
            className="px-6 py-2.5 rounded-full font-bold text-gray-400 hover:text-white transition"
          >
            {t("common.cancel")}
          </button>
          <button
