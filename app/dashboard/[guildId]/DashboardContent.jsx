...
export default function DashboardContent({ initialStats, session, guildId, userHistory }) {
    ...
    // Animación de brillo violeta al actualizar
    ...
    return (
        <section className="flex-1 flex flex-col overflow-y-auto custom-scrollbar bg-transparent pb-32">
            ...
            {/* Header de Estadísticas (Glassmorphism) */}
            ...
            <Link href="/playlists" className="group relative block w-full md:w-1/3 h-[140px] rounded-2xl overflow-hidden outline-none shadow-lg -mt-4">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-[#a855f7]/0 to-[#ec4899]/0 group-hover:from-[#a855f7]/20 group-hover:to-[#ec4899]/20 transition-all duration-500 z-10"></div>
              ...
              <div className="absolute inset-0 z-20 p-6 flex flex-col justify-between">
                <div className="flex justify-between items-start">
                  ...
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-[#ec4899] transition-colors transform group-hover:translate-x-1 group-hover:-translate-y-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                </div>
                
                <div>
                  <h3 className="text-lg font-black text-white tracking-tight group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-[#a855f7] group-hover:to-[#ec4899] transition-all">
                    Tus Playlists
                  </h3>
                  <p className="text-[11px] text-gray-500 font-medium">Gestiona tus colecciones musicales.</p>
                </div>
              </div>
            </Link>
