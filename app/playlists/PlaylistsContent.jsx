        ...
        setPlaylists([
          {
            ...newPlaylist,
            songs:
              typeof newPlaylist.songs === "string"
                ? JSON.parse(newPlaylist.songs)
                : newPlaylist.songs,
          },
          ...playlists,
        ]);
      ...
      <section className="flex-1 flex flex-col overflow-y-auto custom-scrollbar bg-transparent pb-32 pt-10">
        <div className="max-w-[1200px] w-full mx-auto px-6 md:px-10 flex flex-col gap-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            <div>
              <h1 className="text-4xl md:text-6xl font-black text-white tracking-tighter drop-shadow-lg mb-2">
                {t("playlists.title")}
              </h1>

              <p className="text-gray-400 font-medium">
                Gestiona y crea tus colecciones musicales.
              </p>
            </div>
          </div>
              ...
              >
                ...
                <div className="p-4 bg-black/40 backdrop-blur-md">
                  ...
                  <p className="text-xs text-gray-500 font-medium truncate">
                    {pl.songs?.length || 0} {t("playlists.songs")} •{" "}
                    {pl.is_public
                      ? t("playlists.public")
                      : t("playlists.private")}
                  </p>
