        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
          <div className="bg-[#111214] border border-[#2b2d31] rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col animate-slideUp">
            ...
            <div className="p-6 border-b border-[#2b2d31] flex justify-between items-center">
              <h2 className="text-xl font-black text-white">Ajustes de Playlist</h2>
            ...
            <div className="p-6 flex flex-col gap-6">
              ...
              <div className="p-4 border border-red-500/20 bg-red-500/5 rounded-lg flex flex-col items-start gap-3 mt-4">
                ...
                <button 
                  ...
                  disabled={isDeleting} 
                  className="px-4 py-2 bg-red-500/20 text-red-500 hover:bg-red-500 hover:text-white rounded-lg text-xs font-bold transition-colors mt-2"
                >
            ...
            <div className="p-4 border-t border-[#2b2d31] bg-[#0a0a0c] flex justify-end gap-3">
              <button onClick={() => setIsEditModalOpen(false)} className="px-5 py-2.5 rounded-lg font-bold text-sm text-gray-400 hover:text-white transition">Cancelar</button>
              <button 
                onClick={handleSaveEdit} 
                disabled={isSavingEdit || !editName.trim()} 
                className="px-5 py-2.5 rounded-lg font-bold text-sm bg-[#57F287] hover:bg-[#45d16f] text-black transition disabled:opacity-50 shadow-lg"
              >
